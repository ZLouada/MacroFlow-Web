...
exports.calculateISCurve = calculateISCurve;
exports.getISIncomeAtInterestRate = getISIncomeAtInterestRate;
exports.getISInterestRateAtIncome = getISInterestRateAtIncome;
exports.calculateLMCurve = calculateLMCurve;
exports.getLMIncomeAtInterestRate = getLMIncomeAtInterestRate;
exports.getLMInterestRateAtIncome = getLMInterestRateAtIncome;
exports.calculateBOPCurve = calculateBOPCurve;
exports.getBOPIncomeAtInterestRate = getBOPIncomeAtInterestRate;
exports.calculateISLMEquilibrium = calculateISLMEquilibrium;
exports.calculateMundellFlemingEquilibrium = calculateMundellFlemingEquilibrium;
exports.generateChartData = generateChartData;
exports.generateCurveDataSets = generateCurveDataSets;
exports.analyzeFiscalPolicyImpact = analyzeFiscalPolicyImpact;
exports.analyzeMonetaryPolicyImpact = analyzeMonetaryPolicyImpact;
exports.calculateFiscalMultiplier = calculateFiscalMultiplier;
exports.calculateMonetaryMultiplier = calculateMonetaryMultiplier;
exports.calculateSpilloverEffects = calculateSpilloverEffects;
// =============================================================================
// IS CURVE FUNCTIONS
// =============================================================================
/**
 ...
 */
function calculateISCurve(params, yMin = 0, yMax = 5000, numPoints = 100) {
    const { autonomousConsumption, marginalPropensityConsume, taxRate, autonomousInvestment, investmentSensitivity, governmentSpending, exports, importPropensity, } = params;
 ...
 * Y = [A - bi] / leakageRate
 */
function getISIncomeAtInterestRate(params, interestRate) {
    const { autonomousConsumption, marginalPropensityConsume, taxRate, autonomousInvestment, investmentSensitivity, governmentSpending, exports, importPropensity, } = params;
    const leakageRate = 1 - marginalPropensityConsume * (1 - taxRate) + importPropensity;
    const autonomousExpenditure = autonomousConsumption + autonomousInvestment + governmentSpending + exports;
 ...
 */
function getISInterestRateAtIncome(params, income) {
    const { autonomousConsumption, marginalPropensityConsume, taxRate, autonomousInvestment, investmentSensitivity, governmentSpending, exports, importPropensity, } = params;
    const leakageRate = 1 - marginalPropensityConsume * (1 - taxRate) + importPropensity;
    const autonomousExpenditure = autonomousConsumption + autonomousInvestment + governmentSpending + exports;
 ...
 */
function calculateLMCurve(params, yMin = 0, yMax = 5000, numPoints = 100) {
    const { moneySupply, priceLevel, moneyDemandIncomeSensitivity, moneyDemandInterestSensitivity, } = params;
 ...
 * Y = (hi + M/P) / k
 */
function getLMIncomeAtInterestRate(params, interestRate) {
    const { moneySupply, priceLevel, moneyDemandIncomeSensitivity, moneyDemandInterestSensitivity, } = params;
    const realMoneySupply = moneySupply / priceLevel;
 ...
 */
function getLMInterestRateAtIncome(params, income) {
    const { moneySupply, priceLevel, moneyDemandIncomeSensitivity, moneyDemandInterestSensitivity, } = params;
    const realMoneySupply = moneySupply / priceLevel;
 ...
 */
function calculateBOPCurve(params, yMin = 0, yMax = 5000, numPoints = 100) {
    const { worldInterestRate, exports, importPropensity, capitalFlowSensitivity, capitalMobility, } = params;
    const points = [];
    const step = (yMax - yMin) / (numPoints - 1);
 ...
 */
function getBOPIncomeAtInterestRate(params, interestRate) {
    const { worldInterestRate, exports, importPropensity, capitalFlowSensitivity, capitalMobility, } = params;
    if (capitalMobility === 'perfect') {
 ...
 */
function calculateISLMEquilibrium(isParams, lmParams) {
    const { autonomousConsumption, marginalPropensityConsume, taxRate, autonomousInvestment, investmentSensitivity, governmentSpending, exports, importPropensity, } = isParams;
    const { moneySupply, priceLevel, moneyDemandIncomeSensitivity, moneyDemandInterestSensitivity, } = lmParams;
    const leakageRate = 1 - marginalPropensityConsume * (1 - taxRate) + importPropensity;
    const autonomousExpenditure = autonomousConsumption + autonomousInvestment + governmentSpending + exports;
    const realMoneySupply = moneySupply / priceLevel;
 ...
 */
function calculateMundellFlemingEquilibrium(isParams, lmParams, bopParams, exchangeRateRegime) {
    ...
    if (bopParams.capitalMobility === 'perfect') {
        ...
        if (exchangeRateRegime === 'fixed') {
            ...
            const requiredMoneySupply = calculateRequiredMoneySupply(lmParams, Y, bopParams.worldInterestRate);
            return {
                Y,
 ...
 */
function calculateRequiredMoneySupply(lmParams, targetY, targetI) {
 ...
 */
function calculateImpliedExchangeRate(isParams, equilibriumY) {
 ...
 */
function generateChartData(isParams, lmParams, bopParams, yMin = 0, yMax = 5000, numPoints = 100) {
 ...
 */
function generateCurveDataSets(isParams, lmParams, bopParams, yMin = 0, yMax = 5000, numPoints = 100) {
    return [
        {
 ...
 */
function analyzeFiscalPolicyImpact(isParams, lmParams, deltaG) {
 ...
 */
function analyzeMonetaryPolicyImpact(isParams, lmParams, deltaM) {
    const initialEquilibrium = calculateISLMEquilibrium(isParams, lmParams);
    const newLmParams = {
        ...lmParams,
 ...
 */
function calculateFiscalMultiplier(isParams, lmParams) {
 ...
 */
function calculateMonetaryMultiplier(isParams, lmParams) {
    const { marginalPropensityConsume, taxRate, importPropensity, investmentSensitivity } = isParams;
    const { priceLevel, moneyDemandIncomeSensitivity, moneyDemandInterestSensitivity } = lmParams;
    const leakageRate = 1 - marginalPropensityConsume * (1 - taxRate) + importPropensity;
    const b = investmentSensitivity;
 ...
 */
function calculateSpilloverEffects(economyA, economyB, shockDeltaG) {
...
//# sourceMappingURL=mundellFleming.js.map