  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // ClickUp-inspired vibrant palette
        violet: {
          50: '#f5f3ff',
          100: '#ede9fe',
          200: '#ddd6fe',
      ...
      boxShadow: {
        'glass': '0 4px 24px hsl(var(--foreground) / 0.05)',
        'glass-lg': '0 8px 32px hsl(var(--foreground) / 0.08)',
        'glow': '0 0 20px hsl(var(--primary) / 0.3), 0 0 40px hsl(var(--primary) / 0.15)',
        'glow-sm': '0 0 10px hsl(var(--primary) / 0.2), 0 0 20px hsl(var(--primary) / 0.1)',
